...
```{=html}
<div><pre><small><small>source: <a href="https://github.com/scicloj/macroexpand-2025/blob/main/pages/macroexpand_noj.clj">pages/macroexpand_noj.clj</a></small></small></pre></div>
```
