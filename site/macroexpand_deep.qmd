...
```{=html}
<div><pre><small><small>source: <a href="https://github.com/scicloj/macroexpand-2025/blob/main/pages/macroexpand_deep.clj">pages/macroexpand_deep.clj</a></small></small></pre></div>
```
