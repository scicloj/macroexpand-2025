...
```{=html}
<div><pre><small><small>source: <a href="https://github.com/scicloj/macroexpand-2025/blob/main/pages/participation.clj">pages/participation.clj</a></small></small></pre></div>
```
